                ...
                RowLayout {
                    ...
                    Item {
                        ...
                        Rectangle {
                            anchors.fill: parent
                            radius: Style.radiusM
                            color: (typeof Color !== "undefined") ? Color.mSurfaceVariant : "#444444"
                            border.color: searchInput.activeFocus
                                ? ((typeof Color !== "undefined") ? Color.mPrimary : "#BB86FC")
                                : ((typeof Color !== "undefined") ? Color.mOutline : "#666666")
                        ...
                        TextInput {
                            ...
                            selectionColor: (typeof Color !== "undefined") ? Color.mPrimary : "#BB86FC"
                            selectedTextColor: (typeof Color !== "undefined") ? Color.mOnPrimary : "#FFFFFF"
                            font.pixelSize: 14
                            ...
                            Text {
                                ...
                                text: pluginApi?.tr("panel.search-placeholder")
                                color: parent.color
                                opacity: 0.5
